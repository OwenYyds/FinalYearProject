;
$("#gameManager").click(function () {
    $("#tag").text("全部游戏管理");
    $.get("GameList.html", function (data) {
        $("#content").html(data);
    })
})
$("#hotGameManager").click(function () {
    $("#tag").text("热门游戏管理");
    $.get("HotGameList.html", function (data) {
        $("#content").html(data);
    })
})
...
$("#commentsManager").click(function () {
    $("#tag").text("评论管理");
    $.get("commentsList.html", function (data) {
        $("#content").html(data);
    })
})
$("#postManager").click(function () {
    $("#tag").text("用户发帖管理");
    $.get("postList.html", function (data) {
        $("#content").html(data);
    })
})
$("#feedManager").click(function () {
    $("#tag").text("XBOX最新动态管理");
    $.get("feedList.html", function (data) {
        $("#content").html(data);
    })
})
$("#newsManager").click(function () {
    $("#tag").text("外链管理");
    $.get("newsList.html", function (data) {
        $("#content").html(data);
    })
})
$("#adverManager").click(function () {
    $("#tag").text("广告管理");
    $.get("adverList.html", function (data) {
        $("#content").html(data);
    })
})
$("#bannerManager").click(function () {
    $("#tag").text("首页展示游戏管理");
    $.get("bannerList.html", function (data) {
        $("#content").html(data);
    })
})
